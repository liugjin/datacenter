###
* File: electricity-consumption-controller
* User: Pu
* Date: 2020/01/08
* Desc: 
###
...
define ['clc.foundation.angular/controllers/project-base-controller'], (base) ->
  class ElectricityConsumptionController extends base.ProjectBaseController
  ...
  exports =
    ElectricityConsumptionController: ElectricityConsumptionController
