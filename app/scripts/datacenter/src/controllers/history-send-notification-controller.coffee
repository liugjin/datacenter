###
* File: history-send-notification-controller
* User: Pu
* Date: 2020/01/08
* Desc: 
###
...
define ['clc.foundation.angular/controllers/project-base-controller'], (base) ->
  class HistorySendNotificationController extends base.ProjectBaseController
  ...
  exports =
    HistorySendNotificationController: HistorySendNotificationController
