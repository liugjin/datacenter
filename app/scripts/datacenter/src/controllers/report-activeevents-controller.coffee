###
* File: report-activeevents-controller
* User: Pu
* Date: 2020/01/08
* Desc: 
###
...
define ['clc.foundation.angular/controllers/project-base-controller'], (base) ->
  class ReportActiveeventsController extends base.ProjectBaseController
  ...
  exports =
    ReportActiveeventsController: ReportActiveeventsController
