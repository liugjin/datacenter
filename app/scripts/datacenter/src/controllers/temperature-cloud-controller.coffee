###
* File: temperature-cloud-controller
* User: Pu
* Date: 2019/04/04
* Desc: 
###
...
define ['clc.foundation.angular/controllers/project-base-controller'], (base) ->
  class TemperatureCloudController extends base.ProjectBaseController
  ...
  exports =
    TemperatureCloudController: TemperatureCloudController
