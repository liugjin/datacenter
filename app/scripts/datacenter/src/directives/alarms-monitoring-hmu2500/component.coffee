###
* File: alarms-monitoring-hmu2500-directive
* User: David
* Date: 2020/04/27
* Desc:
###
...
define ['../base-directive','text!./style.css', 'text!./view.html', 'underscore', "moment", "rx"], (base, css, view, _, moment, Rx) ->
  class AlarmsMonitoringHmu2500Directive extends base.BaseDirective
    constructor: ($timeout, $window, $compile, $routeParams, commonService)->
      @id = "alarms-monitoring-hmu2500"
  ...
  exports =
    AlarmsMonitoringHmu2500Directive: AlarmsMonitoringHmu2500Directive