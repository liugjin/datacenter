...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment", "rx"], function(base, css, view, _, moment, Rx) {
  var AlarmsMonitoringHmu2500Directive, exports;
  AlarmsMonitoringHmu2500Directive = (function(_super) {
    __extends(AlarmsMonitoringHmu2500Directive, _super);

    function AlarmsMonitoringHmu2500Directive($timeout, $window, $compile, $routeParams, commonService) {
      this.processEvents = __bind(this.processEvents, this);
      this.show = __bind(this.show, this);
      this.id = "alarms-monitoring-hmu2500";
      AlarmsMonitoringHmu2500Directive.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    AlarmsMonitoringHmu2500Directive.prototype.setScope = function() {};

    AlarmsMonitoringHmu2500Directive.prototype.setCSS = function() {
      return css;
    };

    AlarmsMonitoringHmu2500Directive.prototype.setTemplate = function() {
      return view;
    };

    AlarmsMonitoringHmu2500Directive.prototype.show = function(scope, element, attrs) {
    ...
    AlarmsMonitoringHmu2500Directive.prototype.processEvents = function(scope) {
    ...
    AlarmsMonitoringHmu2500Directive.prototype.findParent = function(scope, station) {
      var parent;
    ...
    AlarmsMonitoringHmu2500Directive.prototype.resize = function(scope) {};

    AlarmsMonitoringHmu2500Directive.prototype.dispose = function(scope) {};

    return AlarmsMonitoringHmu2500Directive;
