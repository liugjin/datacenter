...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var AssetManageDirective, exports;
  AssetManageDirective = (function(_super) {
    __extends(AssetManageDirective, _super);

    function AssetManageDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.getAllStations = __bind(this.getAllStations, this);
      this.show = __bind(this.show, this);
      this.id = "asset-manage";
      AssetManageDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    AssetManageDirective.prototype.setScope = function() {};

    AssetManageDirective.prototype.setCSS = function() {
      return css;
    };

    AssetManageDirective.prototype.setTemplate = function() {
      return view;
    };

    AssetManageDirective.prototype.show = function(scope, element, attrs) {
      var getEquipNumber, getNextName, getStationEquipTypes, init, initStatusDevice, loadAllUsers, loadEquipsByAdd, loadStatisticByEquipmentTypes, processTypes, selectType, settingEquipSampleUnits, uploadImage;
      ...
      selectType = (function(_this) {
        return function(type, callback, refresh) {
          var nowStation, sta, _i, _len, _results;
          if (!type) {
            return;
          }
          scope.equipments = [];
          nowStation = _this.commonService.loadStationChildren(scope.station, true);
          _results = [];
          for (_i = 0, _len = nowStation.length; _i < _len; _i++) {
            sta = nowStation[_i];
            _results.push(_this.commonService.loadEquipmentsByType(sta, type, function(err, equips) {
      ...
      initStatusDevice = (function(_this) {
        return function() {
          scope.addShow = false;
      ...
      init = (function(_this) {
        return function() {
          ...
          scope.addImg = _this.getComponentPath('image/add.svg');
          scope.viewImg = _this.getComponentPath('image/view.svg');
          scope.backImg = _this.getComponentPath('image/back.svg');
          scope.saveImg = _this.getComponentPath('image/save-blue.svg');
          scope.detailGreenImg = _this.getComponentPath('image/detail-green.svg');
          scope.editGreenImg = _this.getComponentPath('image/edit-green.svg');
          scope.deleteGreenImg = _this.getComponentPath('image/delete-green.svg');
          scope.copyGreenImg = _this.getComponentPath('image/copy-green.svg');
          ...
          scope.subscribeReturnList = _this.subscribeEventBus('backList', function(msg) {
            scope.equipment = null;
            scope.addShow = false;
            scope.deviceShow = true;
            scope.listShow = true;
          ...
          if ((_ref = scope.subscribeStationId) != null) {
            _ref.dispose();
          }
          scope.subscribeStationId = _this.subscribeEventBus('stationId', function(msg) {
            return _this.commonService.loadStation(msg.message.stationId, function(err, station) {
              scope.station = station;
              return initStatusDevice();
            });
          });
          initStatusDevice();
          return loadAllUsers();
    ...
    AssetManageDirective.prototype.getAllStations = function(refScope, refStation) {
    ...
    AssetManageDirective.prototype.resize = function(scope) {};

    AssetManageDirective.prototype.dispose = function(scope) {
      var _ref, _ref1;
      if ((_ref = scope.subscribeStationId) != null) {
        _ref.dispose();
      }
      return (_ref1 = scope.subscribeReturnList) != null ? _ref1.dispose() : void 0;
    };

    return AssetManageDirective;
