...
define ['../base-directive','text!./style.css', 'text!./view.html', 'underscore', "moment", "echarts"], (base, css, view, _, moment, echarts) ->
  class BarOrLineSingleDirective extends base.BaseDirective
    constructor: ($timeout, $window, $compile, $routeParams, commonService)->
      @id = "bar-or-line-single"
...
#              bbevelflag hidxaxislabel hidyaxisLineShow hidaxislineshow hidtoolboxshow grahpcolor
      # scope.color = ['#00a856','#C3362F','#324354','#D28367','#93C8AC','#799E82','#CD8620','#BCA29B','#6C5685','#819D48','#9B4441','#406C9B','#E68D39']
...
#          return if not value
      ...
      createChartOption = (values, title, type,xname,mutilcolorflag,mutillevelflag,leghidflag,hidsplitlineflag,hidlabelshowflag,lbbevelflag,hidxaxislabel,hidxaxislineshow,hidyaxislineshow,hidtoolboxshow,graphcolor) ->
...
#    values = _.sortBy(_.sortBy(values, 'key'), 'name')
          ...
          legendData = _.uniq _.pluck values, 'name' # 信号名字
          ...
          seriesData = _.map legendData, (value,num) -> (
            dataColor = ''
            if value
