...
define(['underscore', "materialize-css"], function(_, M) {
  ...
  BaseDirective = (function() {
    ...
    BaseDirective.prototype.defaultTemplate = function() {
      return ("<style>\n  #" + this.id + "-prompt-modal.modal.open {\n    border-radius: 5px;\n    border: 1px solid #3573b6;\n  }\n  #" + this.id + "-prompt-modal .modal-content input {\n    text-indent: 15px;\n  }\n  #" + this.id + "-prompt-modal .modal-footer {\n    background-color: #0D2564 !important;\n    font-size: 14px;\n  }\n  #" + this.id + "-prompt-modal .modal-content {\n    background-color: #061239;\n  }\n  #" + this.id + "-prompt-modal .modal-content .p-color{\n    color:#AAC6DF\n  }\n  #" + this.id + "-prompt-modal .modal-footer .modal-cancel .material-icons, #" + this.id + "-prompt-modal .modal-footer .modal-confirm .material-icons {\n    margin-right: 5px;\n  }\n  #" + this.id + "-prompt-modal .modal-footer .modal-confirm, #" + this.id + "-prompt-modal .modal-footer .modal-cancel {\n    width: 116px;\n    height: 100%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n  #" + this.id + "-prompt-modal .modal-footer .modal-confirm {\n    background-color: rgba(75, 165, 248, 0.4);\n  }\n\n</style>\n<div id=\"") + this.id + "-prompt-modal\" class=\"modal\" md-modal>\n  <div class=\"modal-content\">\n      <h5> {{modal.title}} </h5>\n      <p class=\"p-color\"> {{modal.message}} </p>\n      <input type='text' ng-model='modal.comment' ng-show='modal.enableComment'/>\n  </div>\n  <div class=\"modal-footer\">\n    <div ng-click=\"modal.confirm(true)\" class=\"modal-confirm modal-action right modal-close\">\n      <i class=\"material-icons\">done</i>\n      <span>确认</span>\n    </div>\n    <div ng-click=\"modal.confirm(false)\" class=\"modal-cancel modal-action right modal-close\">\n        <i class=\"material-icons\">close</i>\n        <span>取消</span>\n    </div>\n  </div>\n</div>";
    };
    ...
    BaseDirective.prototype.link = function(scope, element, attrs) {
      ...
      scope.stationEventBus = this.subscribeEventBus("stationId", (function(_this) {
        return function(msg) {
          var _ref1;
          if (((_ref1 = scope.station) != null ? _ref1.model.station : void 0) === msg.message.stationId) {
            return;
          }
    ...
    BaseDirective.prototype.getStation = function(scope, id, callback, refresh) {
      ...
      if (!id) {
        scope.station = _.max(_.filter((_ref = scope.project.stations) != null ? _ref.nitems : void 0, function(sta) {
          ...
          var _ref1;
          return (_ref1 = item.model.index) != null ? _ref1 : 0;
        });
        return typeof callback === "function" ? callback() : void 0;
      }
    ...
    BaseDirective.prototype.getSignal = function(scope, id, callback, refresh) {
      ...
      if (((_ref = scope.equipment) != null ? _ref.signals.items.length : void 0) === 0) {
        refresh = true;
      }
      return (_ref1 = scope.equipment) != null ? _ref1.loadSignals(null, (function(_this) {
