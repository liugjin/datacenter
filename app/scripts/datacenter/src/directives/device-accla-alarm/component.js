...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment", "fancytree"], function(base, css, view, _, moment, fct) {
  var DeviceAcclaAlarmDirective, exports;
  DeviceAcclaAlarmDirective = (function(_super) {
    __extends(DeviceAcclaAlarmDirective, _super);

    function DeviceAcclaAlarmDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "device-accla-alarm";
      DeviceAcclaAlarmDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    DeviceAcclaAlarmDirective.prototype.setScope = function() {};

    DeviceAcclaAlarmDirective.prototype.setCSS = function() {
      return css;
    };

    DeviceAcclaAlarmDirective.prototype.setTemplate = function() {
      return view;
    };

    DeviceAcclaAlarmDirective.prototype.show = function(scope, element, attrs) {
      var join, root, roots, sources, _i, _len, _ref, _ref1;
      if (!scope.parameters.template || scope.parameters.template === "") {
        return;
      }
      scope.search = "";
          ...
          return function(event, data) {
            ...
            return data.result = $.Deferred(function(dtd) {
              ...
              return station != null ? station.loadEquipments({
                type: scope.parameters.template
    ...
    DeviceAcclaAlarmDirective.prototype.getIcon = function(type) {
      return {
        html: '<img src="' + this.getComponentPath("icons/" + type + ".svg") + '" class="icon"/>'
      };
    };

    DeviceAcclaAlarmDirective.prototype.resize = function(scope) {};

    DeviceAcclaAlarmDirective.prototype.dispose = function(scope) {};

    return DeviceAcclaAlarmDirective;
