...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var EquipLineorbarHmu2500Directive, exports;
  EquipLineorbarHmu2500Directive = (function(_super) {
    __extends(EquipLineorbarHmu2500Directive, _super);

    function EquipLineorbarHmu2500Directive($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "equip-lineorbar-hmu2500";
      EquipLineorbarHmu2500Directive.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    EquipLineorbarHmu2500Directive.prototype.setScope = function() {};

    EquipLineorbarHmu2500Directive.prototype.setCSS = function() {
      return css;
    };

    EquipLineorbarHmu2500Directive.prototype.setTemplate = function() {
      return view;
    };

    EquipLineorbarHmu2500Directive.prototype.show = function(scope, element, attrs) {
      ...
      scope.selectSignal = (function(_this) {
        return function(signal, index) {
          ...
          scope.hasSelectSignal = _.filter(scope.signalList, function(signal) {
            return signal.check === true;
          });
          if (scope.mode === "now") {
            getTodayData();
          } else {
      ...
      getHistoryData = (function(_this) {
        return function(message) {
          ...
          return _this.commonService.reportingService.querySignalStatistics({
            ...
            var i, j, result, sig, sum, _chartValues, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _n, _o, _ref, _results, _results1;
            if (typeof statistic === "object") {
              ...
              _chartValues = _.sortBy(_chartValues, function(item) {
                return item.index;
              });
              sum = 0;
              return scope.chartValues = _chartValues;
            } else {
              return cleanData();
            }
          });
      ...
      return scope.equipment.loadSignals(null, (function(_this) {
        return function(err, signallists) {
          ...
          if ((_ref1 = scope.subscribSignalID) != null) {
            _ref1.dispose();
          }
          scope.subscribSignalID = _this.commonService.subscribeEventBus('signalId', function(d) {
            var result, sigObj;
            result = _.indexOf(currentSignal, d.message.signalId.signal);
            if (result === -1) {
              currentSignal.push(d.message.signalId.signal);
            }
            sigObj = _.find(scope.signalList, {
              signal: d.message.signalId.signal
            });
            if (sigObj) {
              sigObj.check = true;
            }
    ...
    EquipLineorbarHmu2500Directive.prototype.resize = function(scope) {};

    EquipLineorbarHmu2500Directive.prototype.dispose = function(scope) {
    ...
    return EquipLineorbarHmu2500Directive;
