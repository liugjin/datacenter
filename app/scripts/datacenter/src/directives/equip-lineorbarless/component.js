...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var EquipLineorbarlessDirective, exports;
  EquipLineorbarlessDirective = (function(_super) {
    __extends(EquipLineorbarlessDirective, _super);

    function EquipLineorbarlessDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "equip-lineorbarless";
      EquipLineorbarlessDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    EquipLineorbarlessDirective.prototype.setScope = function() {};

    EquipLineorbarlessDirective.prototype.setCSS = function() {
      return css;
    };

    EquipLineorbarlessDirective.prototype.setTemplate = function() {
      return view;
    };

    EquipLineorbarlessDirective.prototype.show = function(scope, element, attrs) {
      ...
      return scope.equipment.loadSignals(null, (function(_this) {
        return function(err, signallists) {
          var signals;
          signallists = _.filter(signallists, function(signal) {
            return signal.model.signal === "subharmonic" || signal.model.signal === "totalharmonic";
          });
    ...
    EquipLineorbarlessDirective.prototype.resize = function(scope) {};

    EquipLineorbarlessDirective.prototype.dispose = function(scope) {
    ...
    return EquipLineorbarlessDirective;
