...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'lodash', "moment"], function(base, css, view, _, moment) {
  var EventListDirective, exports;
  EventListDirective = (function(_super) {
    __extends(EventListDirective, _super);

    function EventListDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "event-list";
      EventListDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    EventListDirective.prototype.setScope = function() {
      return {
        stationId: "=",
        pageItem: "@"
      };
    ...
    EventListDirective.prototype.setCSS = function() {
      return css;
    };

    EventListDirective.prototype.setTemplate = function() {
      return view;
    };

    EventListDirective.prototype.show = function(scope, element, attrs) {
      var confirmActiveEvent2, confirmStationEvents2, eventSeverity, getPeriod, getSortedEventArray, nextPeriod, previousPeriod, processEvent, subscribeStationEvent, updateDuration, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
      if (!scope.firstload) {
        return;
      }
      window.debugR = scope;
      ...
      scope.queryEventRecords = (function(_this) {
        return function(event, periodType, page, pageItems) {
          var paging, period, sorting, _ref3;
          if (page == null) {
            page = 1;
          }
          if (pageItems == null) {
    ...
    EventListDirective.prototype.dispose = function(scope) {
