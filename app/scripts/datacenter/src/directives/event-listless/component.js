...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'lodash', "moment"], function(base, css, view, _, moment) {
  var EventListlessDirective, exports;
  EventListlessDirective = (function(_super) {
    __extends(EventListlessDirective, _super);

    function EventListlessDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "event-listless";
      EventListlessDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    EventListlessDirective.prototype.setScope = function() {
      return {
        stationId: "=",
        pageItem: "@"
      };
    ...
    EventListlessDirective.prototype.setCSS = function() {
      return css;
    };

    EventListlessDirective.prototype.setTemplate = function() {
      return view;
    };

    EventListlessDirective.prototype.show = function(scope, element, attrs) {
      var confirmActiveEvent2, confirmStationEvents2, eventSeverity, getPeriod, getSortedEventArray, nextPeriod, previousPeriod, processEvent, subscribeStationEvent, updateDuration, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      if (!scope.firstload) {
        return;
      }
      window.debugR = scope;
      if ((_ref = scope.subStationEquipIds) != null) {
        _ref.dispose();
      }
      scope.subStationEquipIds = this.commonService.subscribeEventBus('equipmentId', (function(_this) {
        return function(d) {
          if (d) {
            scope.eventsArray = _.filter(scope.eventsArray, function(event) {
              return event.equipment === d.message.equipmentId.equipment;
            });
      ...
      eventSeverity = (_ref1 = scope.project) != null ? (_ref2 = _ref1.typeModels) != null ? (_ref3 = _ref2.eventseverities) != null ? _ref3.items : void 0 : void 0 : void 0;
      ...
      updateDuration = (function(_this) {
        return function() {
          return scope.timer = setInterval(function() {
            var event, key, progress, _ref4;
            _ref4 = scope.startEvents;
            for (key in _ref4) {
              event = _ref4[key];
      ...
      scope.confirmData = function(data, comment, forceToEnd) {
        var _ref4, _ref5;
        data.operator = (_ref4 = scope.$root) != null ? _ref4.user.user : void 0;
        data.operatorName = (_ref5 = scope.$root) != null ? _ref5.user.name : void 0;
      ...
      scope.filterEvent = function() {
        return (function(_this) {
          return function(event) {
            ...
            if (((_ref4 = scope.equipmentTypes) != null ? _ref4.length : void 0) && ((_ref5 = scope.equipmentTypes) != null ? _ref5.indexOf(event.equipmentType) : void 0) === -1) {
              return false;
            }
      ...
      subscribeStationEvent = (function(_this) {
        return function(stationId) {
          var addChildrenStations, projectName, station, stationIdArray, userName, _ref4, _ref5;
          scope.events = {};
          scope.eventsArray = [];
          scope.startEvents = {};
          ...
          station = scope != null ? (_ref4 = scope.project) != null ? (_ref5 = _ref4.stations) != null ? _ref5.getItem(userName + "_" + projectName + "_" + stationId) : void 0 : void 0 : void 0;
          ...
          addChildrenStations = function(sta) {
            return sta.stations.forEach(function(s) {
              var _ref6, _ref7;
              if (s != null ? (_ref6 = s.model) != null ? _ref6.station : void 0 : void 0) {
                stationIdArray.push(s.model.station);
              }
              if ((s != null ? (_ref7 = s.stations) != null ? _ref7.length : void 0 : void 0) > 0) {
      ...
      scope.queryEventRecords = (function(_this) {
        return function(event, periodType, page, pageItems) {
          var paging, period, sorting, _ref4;
          if (page == null) {
            page = 1;
          }
          if (pageItems == null) {
          ...
          switch (periodType) {
            ...
            case 'previous':
              ...
              break;
            case 'refresh':
              period = (_ref4 = scope.period) != null ? _ref4 : getPeriod();
              break;
            default:
              period = getPeriod();
          }
          ...
          scope.eventRecords = [];
          return _this.commonService.queryEventRecords(event, period != null ? period.startTime : void 0, period != null ? period.endTime : void 0, null, function(err, records, paging2) {
            var _i, _len;
            if (records) {
              for (_i = 0, _len = records.length; _i < _len; _i++) {
                ...
                eventSeverity.forEach(function(e) {
                  var _ref5, _ref6;
                  if ((event != null ? event.severity : void 0) === (e != null ? (_ref5 = e.model) != null ? _ref5.severity : void 0 : void 0)) {
                    return event.color = e != null ? (_ref6 = e.model) != null ? _ref6.color : void 0 : void 0;
                  }
                });
    ...
    EventListlessDirective.prototype.dispose = function(scope) {
      ...
      if ((_ref4 = scope.eventBus5) != null) {
        _ref4.dispose();
      }
      return (_ref5 = scope.subStationEquipIds) != null ? _ref5.dispose() : void 0;
    };

    return EventListlessDirective;
