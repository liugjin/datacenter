...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'lodash', "moment"], function(base, css, view, _, moment) {
  var EventStartlistDirective, exports;
  EventStartlistDirective = (function(_super) {
    __extends(EventStartlistDirective, _super);

    function EventStartlistDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "event-startlist";
      EventStartlistDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    EventStartlistDirective.prototype.setScope = function() {
      return {
        stationId: "=",
        pageItem: "@"
      };
    ...
    EventStartlistDirective.prototype.setCSS = function() {
      return css;
    };

    EventStartlistDirective.prototype.setTemplate = function() {
      return view;
    };

    EventStartlistDirective.prototype.show = function(scope, element, attrs) {
    ...
    EventStartlistDirective.prototype.dispose = function(scope) {
    ...
    return EventStartlistDirective;
