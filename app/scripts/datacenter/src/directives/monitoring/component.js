...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var MonitoringDirective, exports;
  MonitoringDirective = (function(_super) {
    __extends(MonitoringDirective, _super);

    function MonitoringDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "monitoring";
      MonitoringDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    MonitoringDirective.prototype.setScope = function() {
      return {
        filterType: "="
      };
    };

    MonitoringDirective.prototype.setCSS = function() {
      return css;
    };

    MonitoringDirective.prototype.setTemplate = function() {
      return view;
    };

    MonitoringDirective.prototype.show = function(scope, element, attrs) {
    ...
    MonitoringDirective.prototype.selectStation = function(scope, station) {
      var type;
    ...
    MonitoringDirective.prototype.loadStationEquipStatistics = function(scope, station, callback) {
    ...
    MonitoringDirective.prototype.filterStationStatistic = function(station, statistic, callback) {
    ...
    MonitoringDirective.prototype.computeStationStatistic = function(scope, station) {
    ...
    MonitoringDirective.prototype.selectType = function(scope, type, callback, refresh) {
    ...
    MonitoringDirective.prototype.resize = function(scope) {};

    MonitoringDirective.prototype.dispose = function(scope) {
