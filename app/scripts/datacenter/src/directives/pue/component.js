...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var PueDirective, exports;
  PueDirective = (function(_super) {
    __extends(PueDirective, _super);

    function PueDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "pue";
      PueDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    PueDirective.prototype.setScope = function() {};

    PueDirective.prototype.setCSS = function() {
      return css;
    };

    PueDirective.prototype.setTemplate = function() {
      return view;
    };

    PueDirective.prototype.show = function(scope, element, attrs) {
    ...
    PueDirective.prototype.resize = function(scope) {};

    PueDirective.prototype.dispose = function(scope) {};
