...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var StationEnvironmentDirective, exports;
  StationEnvironmentDirective = (function(_super) {
    __extends(StationEnvironmentDirective, _super);

    function StationEnvironmentDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "station-environment";
      StationEnvironmentDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    }

    StationEnvironmentDirective.prototype.setScope = function() {};

    StationEnvironmentDirective.prototype.setCSS = function() {
      return css;
    };

    StationEnvironmentDirective.prototype.setTemplate = function() {
      return view;
    };

    StationEnvironmentDirective.prototype.show = function(scope, element, attrs) {
    ...
    StationEnvironmentDirective.prototype.getStationEnvironment = function(scope, station) {
    ...
    StationEnvironmentDirective.prototype.filterTemplate = function(scope, id, base) {
      var template;
    ...
    StationEnvironmentDirective.prototype.getTemplatesByBase = function(scope, base) {
    ...
    StationEnvironmentDirective.prototype.subscribeSignalValues = function(scope, equipment) {
      var _ref;
      if (equipment) {
    ...
    StationEnvironmentDirective.prototype.resize = function(scope) {};

    StationEnvironmentDirective.prototype.dispose = function(scope) {
    ...
    return StationEnvironmentDirective;
