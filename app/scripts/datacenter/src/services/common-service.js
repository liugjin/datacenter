...
define(['clc.foundation.angular/services/service', 'clc.foundation.angular/live/signal-live-session', 'clc.foundation.angular/live/event-live-session', 'clc.foundation.angular/live/statistic-live-session', 'clc.foundation.angular/live/command-live-session', 'clc.foundation.angular/live/signal-statistic-live-session', 'clc.foundation.angular/live/configuration-live-session', 'underscore', 'rx', 'moment'], function(base, sls, els, esls, cls, ssls, confs, _, Rx, moment) {
  ...
  CommonService = (function(_super) {
    ...
    CommonService.prototype.subscribe = function(topic, callback) {
      var handler;
      handler = this.liveService.subscribe(topic, (function(_this) {
    ...
    CommonService.prototype.rpcGet = function(method, parameters, callback) {
      var data, url;
      data = {
      ...
      return this.uploadService.$http.get(url, {
        params: data
      }).then((function(_this) {
        return function(response) {
          ...
          if (data != null ? data._err : void 0) {
            err = (_ref = data._err.message) != null ? _ref : data._err;
          }
          if (!err && response.status !== 200) {
            err = response.status;
          }
          _this.$rootScope.loading = false;
          return typeof callback === "function" ? callback(err, data, data != null ? data._paging : void 0) : void 0;
        };
    ...
    CommonService.prototype.rpcPost = function(method, parameters, callback) {
      var data, url;
      data = {
        parameters: parameters,
        startTime: new Date
      ...
      this.$rootScope.loading = true;
      data = this.appendToken(data);
      return this.uploadService.$http.post(url, data).then((function(_this) {
        return function(response) {
          var err, _ref;
          data = response.data;
          if (data != null ? data._err : void 0) {
