		...
		var t = function() {
				...
				this.I_Login = function(e, t, s, n, r, o) {
					...
					if (I.browser().msie) try {
						...
						e = !0
					} catch (t) {} else for (var s = 0, n = navigator.mimeTypes.length; n > s; s++) if ("application/hwp-webvideo-plugin" == navigator.mimeTypes[s].type.toLowerCase()) {
						e = !0;
						break
					}
					return e ? 0 : -1
				...
				et.prototype.m_httpRequestSet = [], et.prototype.setRequestParam = function(e) {
					...
					if (this.options.async) {
						var s = c.HWP_SubmitHttpRequest(e, this.options.url, this.options.auth, this.options.data, this.options.timeout); - 1 != s && (t = {
							iRequestID: s,
